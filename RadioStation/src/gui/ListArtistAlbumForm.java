...
public class ListArtistAlbumForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        artistAlbumQuery = java.beans.Beans.isDesignTime() ? null : em.createQuery("SELECT al FROM Album al");
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, artistAlbumList, jTable1);
        ...
        columnBinding.setColumnName("Artistid");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListArtistAlbumForm().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private java.util.List<pojos.Album> artistAlbumList;
