...
public class ListMusicGroupForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        musicGroupQuery = java.beans.Beans.isDesignTime() ? null : em.createQuery("SELECT al FROM Album al");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListMusicGroupForm().setVisible(true);
            }
        });
    }
